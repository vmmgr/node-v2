...
type VMData struct {
	...
	CPU       uint32         `protobuf:"varint,4,opt,name=CPU,proto3" json:"CPU,omitempty"`   //core
	Mem       uint32         `protobuf:"varint,5,opt,name=Mem,proto3" json:"Mem,omitempty"`   //MB
	Boot      uint32         `protobuf:"varint,6,opt,name=Boot,proto3" json:"Boot,omitempty"` //0~9:HDDBoot[0~9] 10:CDROMBoot
	...
	Status    uint32         `protobuf:"varint,13,opt,name=Status,proto3" json:"Status,omitempty"` //0:Start 1:Stop 2:Shutdown 3:Restart 4:HardReset 5:Pause 6:Resume 10:SnapShot
	Mode      uint64         `protobuf:"varint,14,opt,name=Mode,proto3" json:"Mode,omitempty"`     //0:Status 1:VMUpdateNow 2:VMUpdateAfter
	Option0   uint64         `protobuf:"varint,15,opt,name=option0,proto3" json:"option0,omitempty"`
	Option1   string         `protobuf:"bytes,16,opt,name=option1,proto3" json:"option1,omitempty"`
	Option2   string         `protobuf:"bytes,17,opt,name=option2,proto3" json:"option2,omitempty"`
}
...
func (x *VMData) GetGroupID() uint64 {
	if x != nil {
		return x.GroupID
	}
	return 0
...
func (x *VMData) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *VMData) GetOption0() uint64 {
	if x != nil {
		return x.Option0
	}
	return 0
...
func (x *VMData) GetOption1() string {
	if x != nil {
		return x.Option1
	}
	return ""
...
func (x *VMData) GetOption2() string {
	if x != nil {
		return x.Option2
	}
	return ""
...
type StorageData struct {
	...
	Name     string      `protobuf:"bytes,2,opt,name=Name,proto3" json:"Name,omitempty"`
	GroupID  uint64      `protobuf:"varint,3,opt,name=GroupID,proto3" json:"GroupID,omitempty"`
	Driver   uint32      `protobuf:"varint,4,opt,name=Driver,proto3" json:"Driver,omitempty"` //1:virtio
	Mode     uint32      `protobuf:"varint,5,opt,name=Mode,proto3" json:"Mode,omitempty"`     //1~9:AutoMode 10:ManualMode
...
func (x *StorageData) GetID() uint64 {
	if x != nil {
		return x.ID
	}
	return 0
...
func (x *StorageData) GetGroupID() uint64 {
	if x != nil {
		return x.GroupID
	}
	return 0
...
func (x *StorageData) GetDriver() uint32 {
	if x != nil {
		return x.Driver
	}
	return 0
...
func (x *StorageData) GetMode() uint32 {
	if x != nil {
		return x.Mode
	}
	return 0
...
func (x *StorageData) GetMaxSize() uint64 {
	if x != nil {
		return x.MaxSize
	}
	return 0
...
type NetData struct {
	...
	ID      uint64   `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty"`
	Name    string   `protobuf:"bytes,2,opt,name=Name,proto3" json:"Name,omitempty"`
	GroupID []uint64 `protobuf:"varint,3,rep,packed,name=GroupID,proto3" json:"GroupID,omitempty"`
	VLAN    uint32   `protobuf:"varint,4,opt,name=VLAN,proto3" json:"VLAN,omitempty"`
	Option  uint32   `protobuf:"varint,5,opt,name=Option,proto3" json:"Option,omitempty"` //1:Add 2:Delete
...
func (x *NetData) GetGroupID() []uint64 {
	if x != nil {
		return x.GroupID
	}
	return nil
...
func (x *NetData) GetOption() uint32 {
	if x != nil {
		return x.Option
	}
	return 0
...
type NICData struct {
	...
	Name       string `protobuf:"bytes,2,opt,name=Name,proto3" json:"Name,omitempty"`
	GroupID    uint64 `protobuf:"varint,3,opt,name=GroupID,proto3" json:"GroupID,omitempty"`
	NetID      uint64 `protobuf:"varint,4,opt,name=NetID,proto3" json:"NetID,omitempty"`
	MacAddress string `protobuf:"bytes,5,opt,name=MacAddress,proto3" json:"MacAddress,omitempty"`
	Driver     uint32 `protobuf:"varint,6,opt,name=Driver,proto3" json:"Driver,omitempty"`
...
func (x *NICData) GetGroupID() uint64 {
	if x != nil {
		return x.GroupID
	}
	return 0
...
func (x *NICData) GetNetID() uint64 {
	if x != nil {
		return x.NetID
	}
	return 0
...
func (x *NICData) GetDriver() uint32 {
	if x != nil {
		return x.Driver
	}
	return 0
...
type VMStatus struct {
	...
	ID      uint64 `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty"`
	Mode    uint32 `protobuf:"varint,2,opt,name=mode,proto3" json:"mode,omitempty"`       //0:Start 1:Stop 2:Shutdown 3:Restart 4:HardReset 5:Pause 6:Resume 10:SnapShot
	Boot    uint32 `protobuf:"varint,3,opt,name=boot,proto3" json:"boot,omitempty"`       //0:DiskBoot 1:ISOBoot
	Option1 string `protobuf:"bytes,4,opt,name=option1,proto3" json:"option1,omitempty"`  //not used...
	Option2 uint64 `protobuf:"varint,5,opt,name=option2,proto3" json:"option2,omitempty"` //snapshot ID
}
...
func (x *VMStatus) GetMode() uint32 {
	if x != nil {
		return x.Mode
	}
	return 0
...
func (x *VMStatus) GetBoot() uint32 {
	if x != nil {
		return x.Boot
	}
	return 0
...
func (x *VMStatus) GetOption2() uint64 {
	if x != nil {
		return x.Option2
	}
	return 0
...
var file_grpc_proto_rawDesc = []byte{
	...
	0x4e, 0x75, 0x6c, 0x6c, 0x22, 0xac, 0x03, 0x0a, 0x06, 0x56, 0x4d, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x44, 0x12, 0x10, 0x0a,
	0x03, 0x43, 0x50, 0x55, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x43, 0x50, 0x55, 0x12,
	0x10, 0x0a, 0x03, 0x4d, 0x65, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x4d, 0x65,
	0x6d, 0x12, 0x12, 0x0a, 0x04, 0x42, 0x6f, 0x6f, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	,
	...
	,
	...
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x44, 0x18, 0x03, 0x20, 0x03, 0x28, 0x04, 0x52, 0x07, 0x47,
	0x72, 0x6f, 0x75, 0x70, 0x49, 0x44, 0x12, 0x12, 0x0a, 0x04, 0x56, 0x4c, 0x41, 0x4e, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x56, 0x4c, 0x41, 0x4e, 0x12, 0x16, 0x0a, 0x06, 0x4f, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x4f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x4c, 0x6f, 0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x04, 0x4c, 0x6f, 0x63, 0x6b, 0x22, 0xa9, 0x01, 0x0a, 0x07, 0x4e, 0x49, 0x43, 0x44, 0x61,
	...
	,
	...
	,
	...
	0x6f, 0x32, 0xdb, 0x05, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x1b, 0x0a, 0x05, 0x41, 0x64,
	0x64, 0x56, 0x4d, 0x12, 0x07, 0x2e, 0x56, 0x4d, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x07, 0x2e, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12, 0x1e, 0x0a, 0x08, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x56, 0x4d, 0x12, 0x07, 0x2e, 0x56, 0x4d, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x07, 0x2e, 0x52,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12, 0x1e, 0x0a, 0x08, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x56, 0x4d, 0x12, 0x07, 0x2e, 0x56, 0x4d, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x07, 0x2e, 0x52,
...
var file_grpc_proto_depIdxs = []int32{
	...
	1,  // 8: Node.GetVM:input_type -> VMData
	0,  // 9: Node.GetAllVM:input_type -> Null
	2,  // 10: Node.AddStorage:input_type -> StorageData
	2,  // 11: Node.DeleteStorage:input_type -> StorageData
	2,  // 12: Node.UpdateStorage:input_type -> StorageData
	2,  // 13: Node.GetStorage:input_type -> StorageData
	0,  // 14: Node.GetAllStorage:input_type -> Null
	3,  // 15: Node.AddNet:input_type -> NetData
	3,  // 16: Node.DeleteNet:input_type -> NetData
	3,  // 17: Node.UpdateNet:input_type -> NetData
	3,  // 18: Node.GetNet:input_type -> NetData
	0,  // 19: Node.GetAllNet:input_type -> Null
	4,  // 20: Node.AddNIC:input_type -> NICData
	4,  // 21: Node.DeleteNIC:input_type -> NICData
	4,  // 22: Node.UpdateNIC:input_type -> NICData
	4,  // 23: Node.GetNIC:input_type -> NICData
	0,  // 24: Node.GetAllNIC:input_type -> Null
	0,  // 25: Node.StopNode:input_type -> Null
	8,  // 26: Node.AddVM:output_type -> Result
	8,  // 27: Node.DeleteVM:output_type -> Result
	8,  // 28: Node.UpdateVM:output_type -> Result
	1,  // 29: Node.GetVM:output_type -> VMData
	1,  // 30: Node.GetAllVM:output_type -> VMData
	8,  // 31: Node.AddStorage:output_type -> Result
	8,  // 32: Node.DeleteStorage:output_type -> Result
	8,  // 33: Node.UpdateStorage:output_type -> Result
	2,  // 34: Node.GetStorage:output_type -> StorageData
	2,  // 35: Node.GetAllStorage:output_type -> StorageData
	8,  // 36: Node.AddNet:output_type -> Result
	8,  // 37: Node.DeleteNet:output_type -> Result
	8,  // 38: Node.UpdateNet:output_type -> Result
	3,  // 39: Node.GetNet:output_type -> NetData
	3,  // 40: Node.GetAllNet:output_type -> NetData
	8,  // 41: Node.AddNIC:output_type -> Result
	8,  // 42: Node.DeleteNIC:output_type -> Result
	8,  // 43: Node.UpdateNIC:output_type -> Result
	4,  // 44: Node.GetNIC:output_type -> NICData
	4,  // 45: Node.GetAllNIC:output_type -> NICData
	8,  // 46: Node.StopNode:output_type -> Result
